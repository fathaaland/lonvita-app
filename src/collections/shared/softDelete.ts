 ...
 */
export const deletedAtField: Field = {
  name: 'deletedAt',
  type: 'date',
  admin: {
...
export const adminOnlyDelete = ({ req: { user } }: { req: { user: { role?: string } | null } }) =>
  user?.role === 'admin'

export const notDeleted = { deletedAt: { exists: false } } as const
