...
import { getMunicipality, getMyAdministeredMunicipalityId } from "@/integrations/payload/queries";
...
import { BarChart3, CalendarRange, Wallet, HandHeart } from "lucide-react";
      ...
      <div className="px-4 py-5 md:flex md:gap-6 md:items-start">
        ...
        <div className="flex-1 min-w-0">
          <Tabs value={tab} onValueChange={setTab}>
            <TabsList className="w-full h-12 grid grid-cols-4 md:hidden">
