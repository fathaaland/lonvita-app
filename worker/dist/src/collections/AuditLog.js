export const AuditLog = {
    ...
    admin: {
        ...
        description: 'Append-only. Written by server-side hooks (overrideAccess) on sensitive changes — role grants, consent revocation. Not writable or deletable through the API.',
    },
    access: {
