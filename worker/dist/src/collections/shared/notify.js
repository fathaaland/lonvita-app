...
export const notify = (payload, input) => {
    payload
        .create({
...
export const getMunicipalityAdminUserIds = async (payload, municipalityId) => {
 ...
 */
export async function sendNotification(payload, input) {
    try {
