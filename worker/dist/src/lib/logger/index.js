...
const log = (level, message, context) => {
    ...
    consoleMethod[level](JSON.stringify({
        level,
        message,
    ...
    if (logtail)
        keepAliveUntilSettled(logtail[level](message, fields));
};
export const logger = {
     ...
     */
    fatal: (message, context) => log('error', `[FATAL] ${message}`, { ...context, severity: 'fatal' }),
};
