...
export const getGoogleCallbackUrl = (appUrl) => `${appUrl.replace(/\/+$/, '')}${GOOGLE_CALLBACK_PATH}`;
export const buildGoogleAuthorizeUrl = ({ state, callbackUrl }) => {
...
export async function exchangeCodeForAccessToken(code, callbackUrl) {
